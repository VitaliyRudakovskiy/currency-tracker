...
import { activeCurrencyRedux, currencyToConvertRedux } from '@store/reducers/currencySlice';
...
function ModalItem(): JSX.Element {
	...
	const convertedSum = convertCurrencyValue(inputValue, currencyToConvert, activeCurrency);
