...
export const navItemHoverColor = '#00ff00';
export const navItemClickColor = '#268e00';

export const sliderColor = '#d8dbe0';

export const copyrightColor = '#898989';

export const footerTitleColor = '#a3dc00';
